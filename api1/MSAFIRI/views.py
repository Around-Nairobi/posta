...
page_access_token = os.environ.get('MSAFIRI_ACCESS_TOKEN')
facebook_page_id = os.environ.get('MSAFIRI_PAGE_ID')
app_secret = os.environ.get('MSAFIRI_APP_SECRET')
...
@api_view(['GET'])
def index(request):
    return HttpResponse('This is Msafiri')
...
@api_view(['POST'])
def post_on_msafiri_page(request):
