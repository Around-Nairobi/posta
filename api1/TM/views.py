...
page_access_token = os.environ.get('TM_ACCESS_TOKEN')
facebook_page_id = os.environ.get('TM_PAGE_ID')
app_secret = os.environ.get('TM_APP_SECRET')
...
@api_view(['GET'])
def index(request):
    return HttpResponse('This is Teach Me')
