...
page_access_token = os.environ.get('TBTIA_ACCESS_TOKEN')
facebook_page_id = os.environ.get('TBTIA_PAGE_ID')
app_secret = os.environ.get('TBTIA_APP_SECRET')
...
@api_view(['GET'])
def index(request):
    return HttpResponse('This is TBTIA')
...
@api_view(['POST'])
def post_on_tbtia_page(request):
